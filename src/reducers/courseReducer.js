...
export default function(state = initialState, action) {
  switch (action.type) {
    ...
    if(action.payload) {
      return {
        ...state,
        authoredCourses : state.allCourses.filter((course) => course.username === action.payload.username),
        purchasedCourses : state.allCourses.filter((course) => action.payload.courses && action.payload.courses.includes(course._id))
      }
    } else {
      return {
        ...state,
